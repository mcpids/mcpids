...
const (
	EventService_PublishEvent_FullMethodName = "/mcpids.v1.EventService/PublishEvent"
	EventService_PublishBatch_FullMethodName = "/mcpids.v1.EventService/PublishBatch"
)
...
type EventServiceClient interface {
	...
	PublishBatch(ctx context.Context, in *EventBatch, opts ...grpc.CallOption) (*BatchAck, error)
}
...
func (c *eventServiceClient) PublishEvent(ctx context.Context, in *Event, opts ...grpc.CallOption) (*EventAck, error) {
...
func (c *eventServiceClient) PublishBatch(ctx context.Context, in *EventBatch, opts ...grpc.CallOption) (*BatchAck, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchAck)
...
type EventServiceServer interface {
	...
	// PublishBatch publishes multiple events in a single RPC (preferred for high-volume).
	PublishBatch(context.Context, *EventBatch) (*BatchAck, error)
}
...
func (UnimplementedEventServiceServer) PublishEvent(context.Context, *Event) (*EventAck, error) {
	return nil, status.Error(codes.Unimplemented, "method PublishEvent not implemented")
}
func (UnimplementedEventServiceServer) PublishBatch(context.Context, *EventBatch) (*BatchAck, error) {
...
func _EventService_PublishEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).PublishEvent(ctx, req.(*Event))
	}
...
func _EventService_PublishBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).PublishBatch(ctx, req.(*EventBatch))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mcpids.v1.EventService",
	...
	Metadata: "mcpids/v1/events.proto",
}
